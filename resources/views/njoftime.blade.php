      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Njoftimet</h1>
          </div>
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:90%;">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Njoftim</h6>
                ...
                <!-- Card Body -->
                <div class="card-body">
                  <div class="small text-gray-600" style="font-size:90%;">December 12, 2019</div>
