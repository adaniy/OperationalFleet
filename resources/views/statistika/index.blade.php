            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Llojet e hargjimeve</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      <div class="dropdown-header">Koha :</div>
                      <a class="dropdown-item" href="#">Javore</a>
                      <a class="dropdown-item" href="#">Mujore</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="#">Ne Pergjithesi</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Karburant
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-success"></i> Servisime
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-info"></i> Pjese
                    </span>
                  </div>
                </div>
              </div>
